...
const ProductForm = () => {
  ...
  function updateStockStatus(container, variant) {
    const productInventoryWrapper = container.querySelector(selectors.productInventoryWrapper);
    ...
    const inventoryStatusQuantity = container.querySelectorAll(selectors.inventoryStatusQuantity);
    ...
    if (!variant) {
      ...
      productInventoryWrapper && productInventoryWrapper.classList.add(window.themeCore.utils.cssClasses.hidden);
      return;
    }
    ...
    productInventoryWrapper && productInventoryWrapper.classList.remove(window.themeCore.utils.cssClasses.hidden);
  }
